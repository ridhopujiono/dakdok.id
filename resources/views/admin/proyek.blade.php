@extends('admin.layouts.main')
    ...
    <link rel="stylesheet" href="{{asset('admin/assets/vendors/toastify/toastify.css')}}">
                                ...
                                <table class="table table-hover mb-0" id="table_transaksi">
                                    ...
                                    <tbody id="tbody-transaksi">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{url('/ubah_status_proyek')}}" method="POST">
                                                
                                                
                                                <input class="d-none" value="{{$d->id_transaksi_proyek}}" name="id">
                                                @csrf
                                            ...
                                            <td>
                                                <span>
                                                    ...
                                                    <a href="{{$d->pdf}}" hrefid="{{$d->id_transaksi_proyek}}" class="badge bg-primary lihat">lihat</a>
                                                    @if(auth()->user()->role == "2")
                                                    <form action="{{ url('hapus_proyek') }}" method="POST" class="d-inline">
                                                        @csrf
                                                        <input class="d-none" name="id" value="{{ $d->id_transaksi_proyek }}">
        ...
        <script>
            let url = '{{url("/pdf")}}';
            let url_transaksi_proyek = '{{url("/get_transaksi_proyek")}}';
            let ubah_status_proyek = "{{url('/ubah_status_proyek')}}";
            let url_hapus_proyek = "{{url('hapus_proyek')}}";
            let url_detail = "{{url('get_detail_proyek')}}";
            let url_jml = "{{url('get_jml')}}";
        </script>
        <script src="{{asset('admin/assets/js/extensions/lihat_pdf2.js')}}"></script>
        <script src="https://www.gstatic.com/firebasejs/8.4.1/firebase-app.js"></script>
        <script src="https://www.gstatic.com/firebasejs/8.4.1/firebase-database.js"></script>
        <script src="{{asset('admin/assets/js/fbase.js')}}"></script>
        <script src="{{asset('admin/assets/js/transaksi_proyek.js')}}"></script>
            ...
            $(document).ready(function(){
                firebase.database().ref("transaksi_proyek").on("value", function(snapshot) {
                    ...
                    firebase.database().ref("transaksi_proyek").on("value", function(snapshot) {
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold">Order</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_order}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold">survey</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_survey}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold">deal</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_deal}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold" style="font-size: 13px;">dikerjakan</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_dikerjakan}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold">selesai</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_selesai}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        //                                     <div class="col-md-8">
                        //                                         <h6 class="text-muted font-semibold">dibayar</h6>
                        //                                         <h6 class="font-extrabold mb-0">${response.data_dibayar}</h6>
                        //                                     </div>
                        //                                 </div>
                        //                             </div>
                        //                         </div>
                        ...
                        // });
                        // console.log(data_section_count);
                            myAudio.play();
                        }
