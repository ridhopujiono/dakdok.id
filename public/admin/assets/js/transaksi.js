        ...
        success: function (response) {
            $.each(response[0], function(i, val){
                html += `<tr>
                            ...
                            <td>${val.judul_pekerjaan}</td>
                            <td>${val.jenis_order_layanan}</td>
                            <td>`;
                            ...
                            <td>
                                <form action="${url_ubah_status}" method="POST">
                                
                                
                                <input class="d-none" value="${val.id_transaksi}" name="id">
                            ...
                            <td>
                                <span>
                                    ...
                                    <a href="${val.pdf}" hrefid="${val.id_transaksi}" class="badge bg-primary lihat">lihat</a>

                                    <form action="${url_hapus_transaksi}" method="POST">
                                        <input type="hidden" name="_token" value="${csrf_token}">
                                        <input class="d-none" name="id" value="${val.id_transaksi}">
